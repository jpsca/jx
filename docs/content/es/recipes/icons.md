---
title: Iconos SVG
description: Usa componentes para iconos SVG
---

Los componentes son ideales para iconos SVG: encapsulas el código SVG una vez y lo reutilizas en todos lados con tamaño y color personalizables.

## Componente de icono básico
...
## Wrapper genérico de icono

Crea un componente base que los demás iconos extiendan:
...
<IconButton label="Cerrar" @click="close()">
  <IconX size={{ 20 }} />
</IconButton>
```
...
## Iconos rellenos vs. de contorno
...
1. **Usa `currentColor`** en fill/stroke para heredar el color del texto
2. **Define valores por defecto razonables** para el tamaño (24px es lo común)
3. **Agrega `aria-hidden="true"`** en iconos decorativos
4. **Usa `aria-label`** en botones que solo tienen icono
5. **Mantén los SVG optimizados**: elimina atributos innecesarios
